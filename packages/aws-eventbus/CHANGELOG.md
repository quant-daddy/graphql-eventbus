...
- 307d642: Queue creation fix

## 0.5.0

### Minor Changes

- 8d2f5fe: Topic and queue creation logic change. s3 connection config change. Adds documentation.
...
- 6fef2ec: Topic and queue creation logic change. s3 connection config change. Adds documentation.
